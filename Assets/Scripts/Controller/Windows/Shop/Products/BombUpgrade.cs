...
{
    public class BombUpgrade : MonoBehaviour, IShopProduct
    {
        ...
        private void UpdateView()
        {
            ...
            var cost =playerStats.bombRadiusUpgradeCycle * _shopConfig.cost;
        ...
        private void OnClickBuyButton()
        {
            ...
            playerStats.bombRadiusModificator += _shopConfig.increaseValue;
            playerStats.bombRadiusUpgradeCycle++; 
            UpdateView();
        }
    }
}