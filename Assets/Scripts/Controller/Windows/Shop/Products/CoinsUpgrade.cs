...
{
    public class CoinsUpgrade : MonoBehaviour, IShopProduct
    {
        ...
        private void UpdateView()
        {
            ...
            var cost = playerStats.coinsUpgradeCycle * _shopConfig.cost;
        ...
        private void OnClickBuyButton()
        {
            ...
            playerStats.coinsModificator += (int)_shopConfig.increaseValue;
            playerStats.coinsUpgradeCycle++; 
            UpdateView();
        }
    }
}